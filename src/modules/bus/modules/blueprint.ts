  ...
  operations: {
    decompose: {
      handler: async (params: any) => {
        const { decomposeToBlueprint } = await import("@/modules/knowledge-graph");
    ...
    materialize: {
      handler: async (params: any) => {
        const { materializeFromBlueprint } = await import("@/modules/knowledge-graph");
    ...
    verify: {
      handler: async (params: any) => {
        const { verifyBlueprint } = await import("@/modules/knowledge-graph");
