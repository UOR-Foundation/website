  ...
  theme: {
    ...
    extend: {
      ...
      spacing: {
        ...
        /* φ ladder — primary spacing scale */
        "phi-0": "var(--phi-0)",
        "phi-1": "var(--phi-1)",
        "phi-2": "var(--phi-2)",
        "phi-3": "var(--phi-3)",
      ...
      borderRadius: {
        ...
        md: "var(--radius-sm)",
        sm: "var(--radius-xs)",
        "phi-xs": "var(--radius-xs)",
        "phi-sm": "var(--radius-sm)",
        "phi-md": "var(--radius-md)",
        "phi-lg": "var(--radius-lg)",
        "phi-xl": "var(--radius-xl)",
      },
      aspectRatio: {
        phi: "1.618 / 1",
      ...
      maxWidth: {
        "measure-sm": "var(--measure-sm)",
        "measure-md": "var(--measure-md)",
