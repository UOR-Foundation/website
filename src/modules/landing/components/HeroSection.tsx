...
const HeroSection = () => {
  return (
    <section className="hero-gradient relative overflow-hidden h-[100dvh] min-h-[520px] flex flex-col">
      ...
      {/* Copy block — takes ~38.2% of remaining space */}
      <div className="flex-[1] flex flex-col items-center justify-center min-h-0 px-4 pb-[clamp(1rem,3vh,2.5rem)]">
        <p
          className="text-[0.6875rem] md:text-base font-body font-medium tracking-[0.2em] uppercase text-muted-foreground/60 mb-[clamp(0.375rem,1vh,1.25rem)] animate-fade-in-up opacity-0"
