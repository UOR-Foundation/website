...
const LAYERS: Layer[] = [
  {
    ...
    whyItMatters:
      "The framework rests on a single verifiable rule: for any value x, negate(bitwise-invert(x)) always equals x + 1. If this holds, every layer above it holds.",
    solves: "Agents that share no common authority can establish trust through a mathematical proof, not a handshake.",
    endpoints: [
      {
