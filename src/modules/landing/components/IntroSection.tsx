  ...
  return (
    <section id="intro" className="section-dark py-16 md:py-28 scroll-mt-16">
      <div className="container max-w-6xl">
        <p className="text-[0.6875rem] md:text-sm font-body font-medium tracking-[0.2em] uppercase text-section-dark-foreground/50 mb-5 md:mb-6">
          Introducing UOR
        </p>
        ...
        >
          ...
          <a
            href="/about"
            className="inline-flex items-center mt-10 md:mt-14 text-sm md:text-base font-body font-medium tracking-wide text-section-dark-foreground/60 hover:text-section-dark-foreground transition-colors duration-200 group"
          >
        ...
        {/* Ecosystem anchoring */}
        <p
          className="mt-6 md:mt-8 text-section-dark-foreground/35 font-body text-xs md:text-sm tracking-wide uppercase animate-fade-in-up opacity-0"
