        ...
        <div className="py-8 md:py-12 max-w-3xl">
          <div className="rounded-xl border border-border/40 bg-card overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-border/30 bg-muted/30">
              ...
              <span className="w-3 h-3 rounded-full bg-muted-foreground/15" />
              <span className="w-3 h-3 rounded-full bg-muted-foreground/15" />
              <span className="ml-2 text-sm text-muted-foreground/50 font-mono">example.ts</span>
            </div>
            <pre className="p-5 md:p-6 overflow-x-auto text-sm md:text-base leading-[1.7] font-mono text-foreground/80">
