...
const HeroSection = () => {
  return (
    <section className="hero-gradient relative overflow-hidden h-[100dvh] min-h-[520px] flex flex-col">
      ...
      {/* Copy block — left-aligned editorial style */}
      <div className="flex-[1] flex flex-col justify-center min-h-0 px-4 pb-[clamp(1rem,3vh,2.5rem)]">
        <div className="container max-w-6xl">
          ...
          <h1
            className="font-display text-[clamp(1.5rem,3.6vw,3.75rem)] font-bold leading-[1.12] tracking-tight text-foreground animate-fade-in-up opacity-0 max-w-3xl"
          ...
          <p
            className="mt-[clamp(0.75rem,1.5vh,2.5rem)] text-[clamp(0.875rem,1.1vw,1.25rem)] text-muted-foreground leading-[1.68] max-w-xl font-body animate-fade-in-up opacity-0"
          ...
          <div
            className="mt-[clamp(0.75rem,2vh,3.5rem)] flex flex-col sm:flex-row flex-wrap gap-3 animate-fade-in-up opacity-0"
