...
const BlogCanonicalRustCrate = () => {
  return (
    <ArticleLayout
      ...
      standfirst="We gave every digital object its own permanent, content-addressed, self-verifying identity."
      date="April 2, 2026"
      authors={["UOR Foundation Research"]}
      readTime="6 min read"
      heroImage={heroImage}
      heroAlt="uor-foundation canonical Rust crate release"
      heroCaption="The canonical Rust reference implementation: one identity per object, verifiable on any device."
    >
      <p className="lede">
  ...
  Verified locally in under 15 ms.`}</pre>
      ...
      <p>
        Identity now belongs to the object itself, not to any platform. You can verify it on your own machine in seconds. This makes structured data between autonomous systems trustworthy at the object level.
      </p>

      <h2>Try it yourself in under 30 seconds</h2>
      <p>
        Live playground runs entirely in your browser. No account. No server. No data leaves your device. Drop in any file or paste text. Instantly see the identity. Change one character or round-trip the object and watch how the identity behaves exactly as expected.
      </p>
