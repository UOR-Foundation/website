    ...
    security: (
      ...
      >
        <div className="space-y-3.5">
          {[
            ["Status", <span key="s" className={`${isDark ? "text-emerald-400" : "text-emerald-600"} font-body text-sm px-2.5 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-lg`}>QUANTUM-SAFE</span>],
