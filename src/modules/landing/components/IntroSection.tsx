    ...
    <section id="intro" className="py-24 md:py-32 bg-background scroll-mt-16">
      <div className="container max-w-7xl">
        ...
        >
          ...
          <p className="mt-6 text-foreground/70 font-body leading-[1.75] md:leading-[1.85] text-fluid-body">
          ...
          <p className="mt-4 text-foreground/70 font-body leading-[1.75] md:leading-[1.85] text-fluid-body">
