/**
 * TerminalProjection — Instant sidebar-originating terminal panel
 */
        ...
        <>
          ...
          >
            <div
              ...
              style={{ background: "linear-gradient(to bottom, hsla(120, 40%, 55%, 0.0), hsla(120, 40%, 55%, 0.2), hsla(120, 40%, 55%, 0.0))" }}
            />
