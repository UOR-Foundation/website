  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto py-3" style={wallpaperStyle}>
        {/* Encryption notice with session badge */}
        <div className="flex justify-center mb-4 px-4">
          <div className="bg-[#182229] text-[#8696a0] text-[12.5px] rounded-lg px-3 py-1.5 text-center max-w-[360px] shadow-sm flex items-center gap-2">
            <SessionBadge status="active" compact />
            <span>Messages are end-to-end encrypted with UMP. Post-quantum secure.</span>
          </div>
        </div>
