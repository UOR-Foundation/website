      ...
      <div className="container max-w-5xl">
        ...
        >
          ...
          <p className="mt-6 text-section-dark-foreground/75 font-body text-base md:text-lg leading-[1.85] md:leading-[1.9]">
            The same content always resolves to the same address, no matter who holds it. No broken links, no translation layers, no manual integration. Data you can find, verify, and trust across organizational boundaries.
          </p>
          <div className="mt-10 md:mt-12 flex flex-col sm:flex-row gap-3">
            ...
            <a
              href="/about"
              className="inline-flex items-center text-sm md:text-base font-body font-medium tracking-wide text-section-dark-foreground/70 hover:text-section-dark-foreground transition-colors duration-200 group"
            >
